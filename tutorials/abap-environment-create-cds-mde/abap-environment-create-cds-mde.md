---
title: Accsess Test QA Green Create an ABAP Core Data Services (CDS) View in SAP Cloud Platform, ABAP Environment 2 upd View in SAP Cloud Platform, ABAP Environment 2 upd
